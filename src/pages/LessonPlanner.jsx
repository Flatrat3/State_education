                ...
                <main className="glass-card">
                    <div className="table-container">
                        <table>
                            <thead>
                                <tr>
                                    <th className="col-day">Gün №</th>
                                    <th className="col-law">Qanun adı</th>
                                    <th className="col-topic">Alt mövzu</th>
                                    <th className="col-type">Video tipi</th>
                                    <th>Nə izah ediləcək</th>
                                </tr>
                            </thead>
                            <tbody>
                                {lessonData.map((row, index) => (
                                    <tr key={index}>
                                        <td data-label="Gün №" className="cell-day">{row[0]}</td>
                                        <td data-label="Qanun adı" className="cell-law">{row[1]}</td>
                                        <td data-label="Alt mövzu" className="cell-topic">{row[2]}</td>
                                        <td data-label="Video tipi">
                                            <span className={`badge ${getBadgeClass(row[3])}`}>{row[3]}</span>
                                        </td>
                                        <td data-label="Nə izah ediləcək" className="cell-desc">{row[4]}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
